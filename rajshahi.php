...
<body>
<center>
<h1>RAJSHAHI ZONE BLOOD BANK: </h1>
...
$result= mysql_query("SELECT *FROM rajshahi_BB limit 1");
...
mysql_select_db("doner_list");
$result= mysql_query("SELECT *FROM RAJSHAHI_BB limit 1,1");
...
mysql_select_db("doner_list");
$result= mysql_query("SELECT *FROM RAJSHAHI_BB limit 2,1");
