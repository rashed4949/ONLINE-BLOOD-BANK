		...
		<form id="form" action="insert.php" method="post">	
		 ...
		 <p>
				...
				<label>Blood Group </label>
					<input type="text" name="blood_group" size="30" placeholder="Exp:AB+"/>
                ...
                <p>
					<label>Gender</label>
					<input type="text" name="gen"  size="30" />
				</p>
				...
				<p>
					...
					<input type="text" name="dob" size="30" placeholder="exp:10 augest,2015" />
				</p>
                
                <p>
				    <label>Phone no</label>
				    <input type="text" name="phn" size="30" />
				</p>
